...
# RQ job import paths (must match traceflow_jobs.handlers)
PING_JOB = "traceflow_jobs.handlers.ping_job"
EVAL_SPAN_JOB = "traceflow_jobs.handlers.eval_span_job"
EVAL_RUN_JOB = "traceflow_jobs.handlers.eval_run_job"
