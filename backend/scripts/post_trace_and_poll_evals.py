...
Usage (from repo root or from backend/):
  ...
  PYTHONPATH=backend python backend/scripts/post_trace_and_poll_evals.py
  cd backend && PYTHONPATH=. python scripts/post_trace_and_poll_evals.py
"""
...
# Ensure backend/ is on path when run as python scripts/post_trace_and_poll_evals.py from backend/
